...
class AdminVerifyChangePage extends StatefulWidget {
  final String type;
  final String? email;
  final String? phoneNumber;
  const AdminVerifyChangePage({
    Key? key,
    required this.type,
    this.email,
    this.phoneNumber,
  ...
  @override
  State<AdminVerifyChangePage> createState() => _AdminVerifyChangePageState();
}

class _AdminVerifyChangePageState extends State<AdminVerifyChangePage> {
