...
class TanodChangeEmailPage extends StatefulWidget {
  final String email;
  const TanodChangeEmailPage({Key? key, required this.email}) : super(key: key);

  @override
  _TanodChangeEmailPageState createState() => _TanodChangeEmailPageState();
}

class _TanodChangeEmailPageState extends State<TanodChangeEmailPage> {
